  ...
  return (
    <>
      <div className="min-h-screen relative flex items-center justify-center">
        <div className="w-full h-auto py-12 bg-lgreen flex flex-col items-center justify-center">
            ...
            <div className="flex animate-loop-scroll group-hover:paused hover:cursor-pointer">
              ...
              <div className="flex shrink-0 gap-4 md:gap-8 lg:gap-16">
                <img
                  ...
                  className="h-[60px] md:h-[80px] lg:h-[100px] w-auto object-contain transition-transform duration-300 hover:scale-110 hover:-rotate-3"
                  alt="Investor 1"
                />
                <img
